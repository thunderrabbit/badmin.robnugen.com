...
require_once  __DIR__ . "/image_resize_lib.php";   // shared resize + URL/embed helpers (also requires the Bulletproof src)
...
// print_rob() now lives in image_resize_lib.php (shared with ai/confirm_item.php)
...
// create_thumbnail(), create_1000px_nail(), resize_image() now live in image_resize_lib.php
...
// embed_markdown_func(), create_html_img_tag(), alttextify(), urlify()
// now live in image_resize_lib.php (shared with ai/confirm_item.php)
